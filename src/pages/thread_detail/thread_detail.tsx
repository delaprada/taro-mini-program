...
import { timeagoInst, IThreadProps } from '../../utils';
...
function ThreadDetail(props) {
  ...
  const [thread, setThread] = useState<IThreadProps>({} as IThreadProps);
  ...
  const replieEl = replies.map((reply: any, index) => {
